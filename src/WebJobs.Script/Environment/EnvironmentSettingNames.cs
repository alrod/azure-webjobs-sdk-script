...
namespace Microsoft.Azure.WebJobs.Script
{
    public static class EnvironmentSettingNames
    {
        ...
        public const string AzureWebJobsSecretStorageVaultName = "AzureWebJobsSecretStorageVaultName";
        public const string AzureWebJobsSecretStorageAuthConnectionString = "AzureWebJobsSecretStorageAuthConnectionString";
